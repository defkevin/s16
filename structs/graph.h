...
public:
  ...
  virtual bool add_edge(int v1, int v2, int weight =1) = 0; // derived class has to provide the methods. add_edge method doesn't have anything
  ...
  // use dijsktra's algorithm to get the shortest distance from start to all other nodes 
