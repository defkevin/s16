...
struct qt_meta_stringdata_TTTBoard_t {
    QByteArrayData data[4];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TTTBoard_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TTTBoard_t qt_meta_stringdata_TTTBoard = {
    {
QT_MOC_LITERAL(0, 0, 8), // "TTTBoard"
QT_MOC_LITERAL(1, 9, 8), // "finished"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 13) // "buttonClicked"

    },
    "TTTBoard\0finished\0\0buttonClicked"
};
...
void TTTBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TTTBoard::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TTTBoard::finished)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TTTBoard::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TTTBoard.data,
      qt_meta_data_TTTBoard,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TTTBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TTTBoard.stringdata0))
