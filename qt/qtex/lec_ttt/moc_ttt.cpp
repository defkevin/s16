...
struct qt_meta_stringdata_TTT_t {
    QByteArrayData data[4];
    char stringdata0[29];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_TTT_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_TTT_t qt_meta_stringdata_TTT = {
    {
QT_MOC_LITERAL(0, 0, 3), // "TTT"
QT_MOC_LITERAL(1, 4, 14), // "newGameClicked"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8) // "gameOver"

    },
    "TTT\0newGameClicked\0\0gameOver"
};
...
const QMetaObject TTT::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TTT.data,
      qt_meta_data_TTT,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TTT::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TTT.stringdata0))
